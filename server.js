...
const completedTasks = [
  new Task(1, 'Run the code', dat('2023-04-07 10:30'), false),
  new Task(3, 'Make the appointment', dat('2023-04-03 16:59'), false),
  new Task(4, 'Play the game', dat('2023-03-25 17:25'), false),
];
